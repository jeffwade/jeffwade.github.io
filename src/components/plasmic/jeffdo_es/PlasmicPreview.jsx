...
import * as sty from "./PlasmicPreview.module.css" // plasmic-import: JmW7BQJp6k/css

export const PlasmicPreview__VariantProps = new Array("bg")

export const PlasmicPreview__ArgProps = new Array("color", "content")
